...
The repository includes multiple Java files focusing on different algorithmic domains, ranging from simple array manipulations to advanced dynamic programming and graph problems.

### Problem Categories Included:
- **Dynamic Programming & Recursion:** Burst Balloons (`burst_balloon.java`), N-Queens (`nqueens.java`), Frog Jump (`frogjump.java`), Stair Climbing (`stair.java`), Palindrome Partitioning (`palindrome_partition2.java`), House Robber (`rob.java`), Subsets (`subset1.java`)
- **Linked Lists:** Cycle Detection (`detect_cycle.java`, `ll_cycle.java`), Adding Lists (`add_list.java`), Removing Elements (`remove.java`)
- **Strings:** Longest Palindromic String (`lps.java`), Substring Counting (`count_binary_substring.java`), Word Reversal (`reverse_word_string.java`), Minimum Deletions (`minimum_deletion_string.java`)
- **Graphs / BFS / DFS:** Distinct Islands (`distinct_islands.java`), Word Ladder (`word_ladder1.java`)
- **Arrays & Mathematics:** Sum of Subarray Minimums (`subarray_sumMin.java`), Finding Unique Elements (`unique.java`, `unique2.java`), Finding Duplicates (`duplicate.java`), Max Element (`max.java`)
- **Bit Manipulation:** Decimal to Binary (`dtob.java`), Minimum Bit Flips (`min_flip_bits.java`)

## Getting Started

To compile and run any of the solutions, you need to have the Java Development Kit (JDK) installed. 
...
4. Run the compiled Java class:
   ...
   java filename
   ```
   *(Ensure to replace `filename` with the actual file/class name without the `.class` extension)*
...
| [0434-number-of-segments-in-a-string](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/0434-number-of-segments-in-a-string/) | Easy |
...
| [0454-4sum-ii](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/0454-4sum-ii/) | Medium |
| [0456-132-pattern](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/0456-132-pattern/) | Medium |
...
| [3524-find-x-value-of-array-i](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/3524-find-x-value-of-array-i/) | Medium |
| [3525-find-x-value-of-array-ii](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/3525-find-x-value-of-array-ii/) | Hard |
...
| [3534-path-existence-queries-in-a-graph-ii](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/3534-path-existence-queries-in-a-graph-ii/) | Hard |
| [3550-smallest-index-with-digit-sum-equal-to-index](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/3550-smallest-index-with-digit-sum-equal-to-index/) | Easy |
...
| [3875-construct-uniform-parity-array-i](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/3875-construct-uniform-parity-array-i/) | Easy |
| [3876-construct-uniform-parity-array-ii](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/3876-construct-uniform-parity-array-ii/) | Medium |
| [3903-smallest-stable-index-i](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/3903-smallest-stable-index-i/) | Easy |
| [3904-smallest-stable-index-ii](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/3904-smallest-stable-index-ii/) | Medium |
## Math
| Problem Name | Difficulty |
| ------- | ------- |
| [0171-excel-sheet-column-number](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/0171-excel-sheet-column-number/) | Easy |
...
| [3524-find-x-value-of-array-i](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/3524-find-x-value-of-array-i/) | Medium |
| [3525-find-x-value-of-array-ii](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/3525-find-x-value-of-array-ii/) | Hard |
| [3536-maximum-product-of-two-digits](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/3536-maximum-product-of-two-digits/) | Easy |
| [3550-smallest-index-with-digit-sum-equal-to-index](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/3550-smallest-index-with-digit-sum-equal-to-index/) | Easy |
...
| [3754-concatenate-non-zero-digits-and-multiply-by-sum-i](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/3754-concatenate-non-zero-digits-and-multiply-by-sum-i/) | Easy |
| [3756-concatenate-non-zero-digits-and-multiply-by-sum-ii](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/3756-concatenate-non-zero-digits-and-multiply-by-sum-ii/) | Medium |
| [3867-sum-of-gcd-of-formed-pairs](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/3867-sum-of-gcd-of-formed-pairs/) | Medium |
| [3870-count-commas-in-range](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/3870-count-commas-in-range/) | Easy |
| [3871-count-commas-in-range-ii](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/3871-count-commas-in-range-ii/) | Medium |
| [3875-construct-uniform-parity-array-i](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/3875-construct-uniform-parity-array-i/) | Easy |
| [3876-construct-uniform-parity-array-ii](https://github.com/s8sankalp/DataStructuresAndAlgorithm/tree/main/3876-construct-uniform-parity-array-ii/) | Medium |
## Dynamic Programming
| Problem Name | Difficulty |
